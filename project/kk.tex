...
\begin{itemize}
    ...
    le temps.
    \item \textbf{Ajouter son journal alimentaire} \\
...
L'athlète peut consulter les notifications reçues lorsqu'un coach ou un nutritionniste lui envoie un message, partage un plan de repas, ajoute une note, propose un rendez-vous ou effectue toute autre mise à jour concernant son suivi.
\end{itemize}
...
\cline{2-5}
 ...
 & Recommandations Rules-based & 2.9 &
...
\begin{figure}[H]
    \centering
    \IfFileExists{images/classe01.jpg}{%
        \includegraphics[width=0.95\textwidth]{images/classe01.jpg}%
    }{%
        \fbox{\parbox[c][7cm][c]{0.95\textwidth}{\centering Ajouter l'image : \texttt{images/classe01.jpg}}}%
    }
...
\begin{figure}[H]
    \centering
    \IfFileExists{images/automatique.jpg}{%
        \includegraphics[width=0.9\textwidth]{images/automatique.jpg}%
    }{%
...
\begin{figure}[H]
    \centering
    \IfFileExists{images/digrammeclassesprinte2.jpg}{%
        \includegraphics[width=0.95\textwidth]{images/digrammeclassesprinte2.jpg}%
    }{%
...
\paragraph{ Validation}
La figure~\ref{fig:churn} La figure 51 illustre l'interface d'évaluation du risque d'abandon, qui permet à l'utilisateur de visualiser en temps réel son niveau de motivation et son risque de décrochage. 
...
\centering
\renewcommand{\arraystretch}{1.2}
\caption{Répartition du jeu de données selon la méthode GroupShuffleSplit}
...
\begin{itemize}
    \item[\textcolor{blue}{\textbf{[0]}}] \texttt{}
    \item[\textcolor{blue}{\textbf{[1]}}] \texttt{}
    \item[\textcolor{blue}{\textbf{[2]}}] \url{https://fr.wikipedia.org/wiki/Visual_Studio_Code}
    \item[\textcolor{blue}{\textbf{[3]}}] \url{https://fr.wikipedia.org/wiki/Jupyter}
    \item[\textcolor{blue}{\textbf{[4]}}] \url{https://openclassrooms.com/fr/courses/4668056-construisez-des-microservices/5123020-testez-votre-api-grace-a-postman}
    \item[\textcolor{blue}{\textbf{[5]}}] \url{https://fr.wikipedia.org/wiki/Docker_(logiciel)}
    \item[\textcolor{blue}{\textbf{[6]}}] \url{https://fr.wikipedia.org/wiki/StarUML}
    \item[\textcolor{blue}{\textbf{[7]}}] \url{https://fr.wikipedia.org/wiki/GitHub}
    \item[\textcolor{blue}{\textbf{[8]}}] \url{https://fr.wikipedia.org/wiki/Python}
    \item[\textcolor{blue}{\textbf{[9]}}] \url{https://fr.wikipedia.org/wiki/Next.js}
    \item[\textcolor{blue}{\textbf{[10]}}] \url{https://fr.wikipedia.org/wiki/NestJS}
    \item[\textcolor{blue}{\textbf{[11]}}] \url{https://fr.wikipedia.org/wiki/React}
    \item[\textcolor{blue}{\textbf{[12]}}] \url{https://fr.wikipedia.org/wiki/Node.js}
    \item[\textcolor{blue}{\textbf{[13]}}] \url{https://fr.wikipedia.org/wiki/Hypertext_Markup_Language}
    \item[\textcolor{blue}{\textbf{[14]}}] \url{https://fr.wikipedia.org/wiki/Tailwind_CSS}
    \item[\textcolor{blue}{\textbf{[15]}}] \url{https://fr.wikipedia.org/wiki/TypeScript}
    \item[\textcolor{blue}{\textbf{[16]}}] \url{https://fr.wikipedia.org/wiki/PostgreSQL}
\end{itemize}
\end{document}
